...
app.get('/get-products1', productController.getProducts1)
...
app.post('/verify-product/:productId', productController.verifyProduct);
app.post('/reject-product/:productId', productController.rejectProduct);
